...
function unixreaddir(parent) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            promises.readdir(parent, { recursive: true })
                .then((paths) => {
                resolve(paths.map((path) => posix.normalize(path.replace(/\\/g, "/"))));
            })
                .catch((err) => {
...
exports.groupByDirname = groupByDirname;
exports.unixreaddir = unixreaddir;
